...
2.  Run the RadioNode terminal program and enter the password **`radionode114`** to open the console menu.
    ![RadioNode Console Menu](images/Tago_RN172/Image_7.png)
3.  In the **Network Setup** menu, add the Wi-Fi **SSID** and **password**.
    ![RN172 Terminal WiFi Setup](images/Tago_RN172/Image_8.png)
...
![RN172 Terminal HTTP Destination Setup](images/Tago_RN172/Image_9.png)
![RN172 Terminal HTTP Setup Details](images/Tago_RN172/Image_10.png)
...
![Tago.io Device Data View](images/Tago_RN172/Image_11.png)
...
4.  Choose the device from where the data needs to be shown in real time.
    ![Tago.io Widget Configuration](images/Tago_RN172/Image_14.png)

A sample dashboard is shown below.
![Tago.io Sample Dashboard](images/Tago_RN172/Image_15.png)
